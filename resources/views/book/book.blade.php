    ...
    <div class="container row" style="margin: 0 auto; max-width: 1200px;">
        ...
        <div class="col-8" style="margin-bottom: 40px;">
            <div class="col-lg-12 row">
                <label style="font-size: 14px;cursor: pointer;"><a onclick="history.back();">< {{ __('book.back') }}</a></label>
                        ...
                        <div class="d-flex" style="margin-top: 20px">
                            <div class="d-block">
                                ...
                                <div class="d-flex medie">
                                    @for($i = 1; $i < $punteggio+1; $i++)
                                        <i class="fas fa-star rec" @click="recensioni({{ $i }})"></i>
                                    @endfor
                                    @for($i = $punteggio+1; $i < 6; $i++)
                                        <i class="fas fa-star rec removed" @click="recensioni({{ $i }})"></i>
                                    @endfor
                                </div>
                            </div>
                        </div>
