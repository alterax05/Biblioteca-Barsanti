    ...
    <div class="col-8">
        <div style="margin-bottom: 20px;">
            ...
            <a href="/profile/generate">
                <button class="btn btn-primary">Esporta un file CSV</button>
            </a>
            <?php endif; ?>
        </div>

        <h5><?php echo e((!$restituzione)?'Prestiti in corso' : 'Restituiti'); ?></h5>
        <div class="libri">
...
<?php echo $__env->make('template.profile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edoardo/PhpstormProjects/bibliotecaLaravel/resources/views/auth/profile/index.blade.php ENDPATH**/ ?>