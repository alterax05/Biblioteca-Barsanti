                    ...
                    <div class="col-9 row">
                        <div class="col-8">
                            ...
                            <div class="d-flex" style="margin-top: 10px" v-if="book.media != 0">
                                ...
                                <div class="genere" v-if="book.belongs_autori[0].belongs_autore.belongs_scheda != null && book.belongs_autori[0].belongs_autore.belongs_scheda.nobel != null">
                                    <div class="d-flex flex-row">
...
<?php echo $__env->make('template.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\biblioteca.barsanti.edu.it\httpdocs\resources\views/book/index.blade.php ENDPATH**/ ?>