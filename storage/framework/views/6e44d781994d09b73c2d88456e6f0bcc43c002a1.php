                ...
                <div class="libro row cc-card spacer-card">
                    ...
                    <div class="col-9 row">
                        <div class="col-8">
                            ...
                            <p style="margin-top: 10px;font-size: 15px;">Prestato a: <?php echo e($libro->name); ?> <?php echo e($libro->surname); ?> (<b><?php echo e($libro->class); ?></b>)</p>
                        </div>
                        <div class="col-4 dettagli" style="margin-top: 0;">
                            <p><b>Data prestito:</b> <?php echo e($libro->data_prestito); ?></p>
...
<?php echo $__env->make('template.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mikyp\Downloads\backup_biblioteca.barsanti.edu.it\httpdocs\resources\views/admin/prestiti.blade.php ENDPATH**/ ?>