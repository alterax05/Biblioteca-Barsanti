<?php $__env->startSection('profile-content'); ?>
    <div class="col-8">
        ...
        <h5><?php echo e(__('profile.your_favourites')); ?></h5>
        <div class="libri">
                ...
                <div class="libro row cc-card spacer-card">
                    ...
                    <div class="col-9 row">
                        ...
                        <div class="col-4 dettagli">
                            <?php if(Auth()->user()): ?>
                                <a href="/post/preferiti/<?php echo e($libro->ISBN); ?>" style="text-decoration: none"><button class="d-block btn btn-danger" style="font-size: 12px;margin-bottom: 10px;"><?php echo e(__('profile.remove_fav')); ?></button></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('template.profile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\biblioteca.barsanti.edu.it\httpdocs\resources\views/auth/profile/preferiti.blade.php ENDPATH**/ ?>